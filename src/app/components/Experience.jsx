  ...
  const experiences = [
    {
      ...
      description:"Developing a live website with Next.js to provide full-stack, SEO-friendly solutions while adhering to industry norms such as Agile process and project management with JIRA.",
        ...
        {experiences.map((exp, index) => (
          <div
            ...
            className={`mb-12 flex flex-col md:flex-row ${
              index % 2 === 0
                ? "md:items-start"
                : "md:flex-row-reverse md:items-end"
          ...
          >
            ...
            <div className="hidden md:flex flex-col items-center">
              <div className="w-16 h-16 bg-white border-1 border-black  hover:scale-110 transition-all ease-in-out duration-100  rounded-full z-20 flex items-center justify-center shadow-md">
                <img
                  src={exp.logo}
